package mobile;
	...
	public class nuronics { 
		static String text3 = "Class II";
	 ...
	 */
		...
		@Test(priority = 8)
		public static void LoginValid() throws Throwable {
	   ...
	   //  System.out.println(tex);
		 ...
		 public static void ForgotpasswordValid() throws InterruptedException {
			...
			//	Thread.sleep(1000);
				...
				System.out.println("password sent  success");
				   System.out.println("Test pass");
				Thread.sleep(2000);
				...
				System.out.println("password sent  failed");
				   System.out.println("Test fail");
			}
		}
		...
		public static void ForgotpasswordNull() throws InterruptedException {
		 ...
		 public static void profile() throws InterruptedException {
			...
			driver.findElement(By.id("com.tss.nuronics:id/text_input_edit_name")).sendKeys("isha5");
			Thread.sleep(1000);
			driver.findElement(By.id("com.tss.nuronics:id/text_input_edit_email")).sendKeys("isha@mailinator.com");
			Thread.sleep(1000);
			...
			Thread.sleep(5000);
			System.out.println("::::::::::::::::user checking profile with NULL data");
			driver.findElement(By.id("com.tss.nuronics:id/edit_icon_menu")).click();
			Thread.sleep(1000);
		...
		public static void Changepassword() throws InterruptedException {
			...
			Thread.sleep(1000);
			System.out.println(":::::::::user updating the password");
			driver.findElement(By.xpath(
					"//android.widget.EditText[contains(@resource-id,'text_input_edit_old_password') and @text='Old password']"))
					.sendKeys("The@1234");
			driver.findElement(By.xpath(
			...
			driver.findElement(By.xpath("//android.widget.Button[contains(@resource-id,'btnupdate') and @text='UPDATE']"))
					.click();
			System.out.println("change password updated success");
		...
		public static void settings() throws InterruptedException {
			...
			// driver.findElement(By.className("android.widget.ImageView")).click();
			// Thread.sleep(2000);
			driver.findElement(By.xpath("//android.widget.TextView[contains(@resource-id,'textview') and @text='Class III']")).click();
			Thread.sleep(1000);
			swipee();
			...
			System.out.println(dd.get(3).getText());
		...
		Thread.sleep(5000);
			swipee();
			System.out.println("swipe up success");
