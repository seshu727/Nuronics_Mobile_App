...
//	 static String text7 = "Password length sHould be min 8 characters";
	...
	public static void main(String[] args) throws Throwable {
		...
		n.InavlidPassWord();
		n.LoginNull();
		n.ForgotpasswordValid();
		n.ForgotpasswordInValid();
		n.ForgotpasswordNull();
		n.LoginValid();
		n.profile();
		n.Changepassword();
		n.actionsbtn();
		n.logout();
		n.LoginAfterupdating();
		n.actionsbtn();
	...
	public static void settings() throws InterruptedException {
		...
		// Thread.sleep(2000);
		driver.findElement(
				By.xpath("//android.widget.TextView[contains(@resource-id,'textview') and @text='Class II']")).click();
		Thread.sleep(1000);
		swipee();
